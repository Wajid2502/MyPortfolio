    ...
    <section className="text-gray-600 body-font pt-16 lg:min-h-75vh">
      <div className="p-5 mx-auto gap-2 flex flex-col md:pt-12 md:px-7 lg:py-20 lg:flex-row-reverse items-center min-h-fit">
        ...
        <div className="lg:flex-grow lg:pr-4 lg:mr-14 flex flex-col md:mb-0 items-center text-center xl:scale-105">
          ...
          >
            Hello , I am <span className="text-dark-orange">Wajid Ali</span>
          </h2>
          <div
            data-aos="zoom-in-up"
            data-aos-duration="1500"
          ...
          >
            I excel in building high-performance web
          </p>
          <p
            data-aos="zoom-in-up"
            data-aos-duration="2000"
            ...
            className="mb-2 text-white text-lg md:text-xl leading-relaxed"
          >
            applications, crafting seamless user experiences,
          </p>
          <p
            data-aos="zoom-in-up"
            data-aos-duration="2000"
          ...
          >
            and delivering innovative, cutting-edge solutions.
          </p>
          ...
          >
            ...
            <a
              href="https://drive.google.com/drive/u/0/folders/15YMYWHhp9rmmvKqALA9DYWTfZZ0LnsKp"
              target="_blank"
              rel="noreferrer"
            >
