  ...
  return (
    ...
    >
      <a
        ...
        href="https://github.com/Wajid2502"
        target="_blank"
        rel="noreferrer"
      >
        <FaGithub />
      ...
      <a
        className="text-white text-2xl md:text-xl transition duration-700 hover:scale-125"
        href="https://www.linkedin.com/in/wajidali1995/"
        target="_blank"
        rel="noreferrer"
      >
        <FaLinkedin />
      ...
      <a
        className="text-white text-2xl md:text-xl transition duration-700 hover:scale-125"
        href="https://discordapp.com/users/wajidali_"
        rel="noreferrer"
        target="_blank"
      >
        <FaDiscord />
      ...
      <a
        className="text-white text-2xl md:text-xl transition duration-700 hover:scale-125"
        href="https://www.instagram.com/wajidqayyum2502/"
        target="_blank"
        rel="noreferrer"
      >
        <FaInstagram />
